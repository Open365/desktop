...
define([
	...
	angular.module('logoutNotifier', [])
		.controller('logoutNotifierController', ['logoutNotifierService', '$translate', function (logoutNotifierService, $translate) {
			var controller = new LogoutNotifierController(logoutNotifierService, $translate);
			controller.init();
			return controller;
		}])
